...
#Icon
root.iconphoto(False, PhotoImage(file="img/task.png"))

#Top bar
TopImage = PhotoImage(file="img/topbar.png")
Label(root, image=TopImage).pack()

heading = Label(root, text="To-Do List", font="Helvetica 24 bold", fg="white", bg="#283747")
heading.place(x=110, y=20)


frame = Frame(root, width=400, height=50, bg="gray")
...
#listbox
frame1 = Frame(root, bd=3, width=700, height=280, bg="#283747")
...
# Buttons
button_frame = Frame(root, bg="#283747")
